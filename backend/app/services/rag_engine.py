...
_EMBED_DIM = 1536  # must match text-embedding-3-small output dimensionality
...
# ---------------------------------------------------------------------------
# *** SWAP INSTRUCTIONS ***
# When you obtain an OpenAI API key, set it as OPENAI_API_KEY in your .env
# file.  The functions below will automatically detect the key and return
# real OpenAI models instead of the mocks — no code changes required.
# ---------------------------------------------------------------------------
